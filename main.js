...
function success(position) {
    ...
    marker = L.marker([latitude, longitude], { icon: userIcon }).addTo(map).bindPopup("<p class='text-xl text-[#facc15] font-bold text-center font-Poppins'>Lokasi anda sekarang</p>");
