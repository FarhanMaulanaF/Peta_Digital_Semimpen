...
function success(position) {
    ...
    marker = L.marker([latitude, longitude], { icon: userIcon }).addTo(map).bindPopup("<p class='text-xl text-[#f00] font-bold'>Lokasi anda sekarang. Melakukan Pengetesan Hehehehe</p>");
